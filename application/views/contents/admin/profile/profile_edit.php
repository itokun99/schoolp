								...
								<div class="panel-body pan">
									...
									<div class="col-lg-4" style=" text-align: center">
										...
										<?php if (file_exists("assets/images/profile/mm_$member->picture")) { ?>
											<img src="assets/images/profile/mm_<?php echo $member->picture ?>" width="300" class="img-rounded" border="0">
										<?php } else { ?>
									...
									<div class="col-lg-8">
										<div class="form-body pal">
											 ...
											 <div class="form-group">
												...
												<div class="col-lg-9">
												   <div class="col-lg-10 row">
													  <input type="Text" class="form-control" name="parent_nik" id="parent_nik" value="<?php echo $member->parent_nik ?>" required="true" />
												   </div>
												</div>
											 </div>
											 <div class="form-group">
											 ...
											 <div class="form-group">
												...
												<div class="col-lg-9">
												   <div class="col-lg-10 row">
													  <input type="Text" class="form-control" name="birth_place" id="birth_place" value="<?php echo $member->birth_place ?>">
												   </div>
												</div>
											 </div>
											 <div class="form-group">
												...
												<div class="col-lg-9">
												   <div class="col-lg-10 row">
													 <select name="birth_day" class="form-control" style="width: 80px; display: inline;" autocomplete="off">
													 ...
													 <select name="birth_month" class="form-control" style="width: 120px; display: inline;">
													 ...
													 <select name="birth_year" class="form-control" style="width: 80px; display: inline;" autocomplete="off">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
		...
		$('#btnSave').on('click', function () {
			...
			if (mobilephone == "")
			{
				msg = "Please fill your Mobile Phone first.";
				xvalid = 0;
			}
	
			if (email == "")
			{
				msg = "Please fill your Email first.";
				xvalid = 0;
			}
			else
			{
				...
				{
					msg = "Please input your e-Mail address in the right format (e.q.:yourname@company.com).";
					xvalid = 0;
				}	
			}
			...
			if (parent_nik == "")
			{
				msg = "Please fill your NIK first.";
				xvalid = 0;
			}
			
			if (fullname == "")
			{
				msg = "Please fill your Name first.";
				xvalid = 0;
			}
			
			if (xvalid == 1)
			{
				start_valid=confirm("Are you sure to Edit Profile ?")
