					...
					<div class="row">
						<div class="col-md-12" style="min-height: 400px">
							...
							<div class="col-lg-12" style="height: 10px"></div>
									...
									<div class="col-lg-3"></div>
									<div class="col-lg-12" style="hegiht: 10px"></div>
										...
										<table id="reportTables" class="table table-bordered" cellspacing="0" width="100%">
										  <thead>
											<tr>
											  ...
											  <th style="width: 120px; text-align: center">Untuk</th>
											  ...
											  <th style="width: 50px; text-align: center">Baca</th>
											</tr>
										  </thead>
										  <tbody>
											...
											<tr>
											  ...
											  <td style="text-align: center"><?php echo $message->school_name ?></td>
											  <td style="text-align: center">
									...
									<?php } else { ?>										
										<div align='center' class='alert-box info'>Tidak Ada Data di Databse.</div>
									<?php } ?>	
									</div>
