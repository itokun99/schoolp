							...
							<div class="box-body">
								 ...
								 <input type="Hidden" name="message_id" value="<?php echo $message_id ?>">
									<div class="form-body pal">
										<div class="form-group">
										   <label class="control-label col-lg-3">Balas Kepada</label>
										   <div class="col-lg-9">
										...
										<div class="form-group">
										   ...
										   <div class="col-lg-9">
										      <div class="col-lg-12 row">
												  <input type="text" class="form-control" value="<?php echo $message->school_name ?>" disabled>
											  </div>
										   </div>
										</div>
										<div class="form-group">
										   <label class="control-label col-lg-3">Anak</label>
										   <div class="col-lg-9">
										      <div class="col-lg-12 row">
												  <input type="text" class="form-control" value="<?php echo $message->student_name ?>" disabled>
											  </div>
										   </div>
										</div>
								...
								<?php } else { ?>
									...
									<div class="alert alert-grey" style="padding: 5px;">
										<div style="text-align: center; height: 24px"><font color="#cc3300">Tidak Ada Siswa di Databse.</font></div>
								    </div>
