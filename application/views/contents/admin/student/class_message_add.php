	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-content">
				<h4 class="card-title">Pesan Untuk Guru</h4>
					<div class="row">
						<div class="col-md-12" style="min-height: 400px">
							...
							<div class="box-body">
									...
									<input type="Hidden" name="school_id" value="<?php echo $school_id ?>">
								 	<div class="form-body pal">
										...
										<div class="form-group">
										   ...
										   <div class="col-lg-9">
											  <div class="col-lg-12 row">
												 <button id="btnSave" type="submit" class="btn btn-info">&nbsp;Kirim&nbsp;</button>												 
											  </div>
										   </div>
										</div>
								...
								<?php } else { ?>
									...
									<div align='center' class='alert-box info'>Fitur ini tidak bisa di akses <br>karena anda belum terdaftar di kelas ini.</div>
								<?php } ?>
