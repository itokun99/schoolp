				...
				<h4 class="card-title">Daftar Nilai</h4>
					<div class="row">
						<div class="col-md-12" style="min-height: 400px">
										...
										<?php if (isset($dailyexams) && count($dailyexams) > 0) { ?>
											<table id="userTables2" class="table table-bordered" cellspacing="0" width="100%">										  
											  <thead>
												<tr>
												  <th class="col-lg-1" style="width: 70px; text-align: center">Tanggal</th>
												  <th class="col-lg-3" style="width: 120px; text-align: center">Mata Pelajaran</th>
												  <th class="col-lg-1" style="width: 70px; text-align: center">Tipe</th>
												  <th class="col-lg-4" style="text-align: center">Deskripi</th>
												  <th class="col-lg-2" style="text-align: center">Guru</th>
												  <th class="col-lg-1" style="text-align: center">Nilai</th>
												</tr>
											  </thead>
											  <tbody>
												<?php foreach($dailyexams as $data) { ?>
												<tr>
												  ...
												  <td style="text-align: center"><?php echo $data->exam_type_name ?></td>
