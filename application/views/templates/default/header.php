...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/font-material.css">
	...
	<script src="assets/js/jquery.tagsinput.js" type="text/javascript"></script>
	
	<link type="text/css" rel="stylesheet" href="assets/css/jqselect.css">
	<script type="text/javascript" src="assets/js/jqselect.js"></script>
	
	<link type="text/css" rel="stylesheet" href="assets/css/fullcalendar.css">
...
<div class="spinner-img-web" style="position: absolute; top: 45%; left: 45%; z-index: 99999;">
	<div align="center"><img src="assets/images/loading.gif"/></div>
</div>
...
?>
	...
	<?php
		...
		else if ($menu_id == 43) $menu_student_silabus = "active";
    ?>
<div class="wrapper">
        <div class="sidebar" data-active-color="black" data-background-color="black" data-image="assets/img/sidebar-1.jpg">         
            <div class="logo">
                <a class="simple-text">
                    ORANGTUA
                </a>
            ...
            <div class="sidebar-wrapper">
                <div class="user">
                    ...
                    <div class="info">
						...
						<div class="form-group" style="text-align: center; margin: 0px">
							  <select name="children_id" onchange="document.frm.submit()" class="form-control" style="width: 85%; height: 28px; padding: 0px 0px 0px 5px; background-color: #efefef; display: inline" autocomplete="off" required="yes">
                ...
                <ul class="nav nav-sidebar">
					...
					<li class="<?php echo $menu_student_exam ?>"><a href="classroom/class_exam_schedule"><i class="fa fa-book"></i><p>Jadwal & Nilai Ujian</p></a></li>
					<li class="<?php echo $menu_student_daily_exam ?>"><a href="classroom/class_daily_exam"><i class="fa fa-book"></i><p>Daftar Nilai</p></a></li>
					...
					<li class="<?php echo $menu_student_silabus ?>"><a href="silabus"><i class="fa fa-book"></i><p>Silabus</p></a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
							...
							<li id="autonotification" class="dropdown"></li>
                            ...
                            <li>
                                <a href="login/signout" title="Sign Out">                                    
									<button type="button" id="btn-signout" class="btn btn-danger btn-round" style="position: relative; top: -5px;"><i class="fa fa-sign-out"></i> Kembali Ke Website</button>
									<p class="hidden-lg hidden-md"><i class="fa fa-sign-out"></i> Kembali Ke Website</p>
                                </a>
                            </li>
                        </ul>
...
<script>
	$(document).ready(function() {
		...
		$("#autonotification").load("notification/auto_notify");
		var refreshId = setInterval(function() 
		{
		  $("#autonotification").load("notification/auto_notify");
		...
		<?php if ($this->session->userdata('schoolp_total_reminder') <> 0) { ?>
		$('#myModalReminder').modal('show');
		<?php } ?>
				
		$('#myModalReminder').on('shown.bs.modal', function (e) {
			//$("#iframeId").attr("src", $(this).attr("href"));
			var loadurl = "reminder/auto_reminder";
	...
	<div class="modal-dialog modal-big">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h5 class="modal-title" id="myModalLabel"><strong>
				Pengingat Biaya Sekolah</strong></h5>
			</div>
...
<div class="modal fade" id="myModalNotify" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
	<div class="modal-dialog modal-big">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">clear</i></button>
				<h5 class="modal-title" id="myModalLabel"><strong>Notifikasi</strong></h5>
			</div>
			<div class="modal-body">
				<div class="instruction">
					<div class="row">
...
<div class="modal fade" id="myModalReminder" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">clear</i></button>
				<h5 class="modal-title" id="myModalLabel"><strong>Alarm</strong></h5>
			</div>
			<div class="modal-body">
				<div class="instruction">
					<div class="row">
...
<div class="modal fade" id="myModalReminderDetail" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
	<div class="modal-dialog modal-big">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">clear</i></button>
...
<script type="text/javascript">
	 $('#myModalNotify').on('show.bs.modal', function (e) {
		//$("#iframeId").attr("src", $(this).attr("href"));
	 ...
	 $('#myModalReminderDetail').on('show.bs.modal', function (e) {
		//$("#iframeId").attr("src", $(this).attr("href"));
		var loadurl = $(e.relatedTarget).data('load-url');
		$(this).find('.modal-body').load(loadurl);
