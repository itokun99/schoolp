...
<body bgcolor="#ffffff">
		...
		<div class="box-body">
			 ...
			 <div class="col-lg-10">
				...
				<tbody>
				    <tr>
					    <td width="100" bgcolor="#efefef">Date</td>
						<td><?php echo $calendar->calendar_date_ok ?></td>
				    </tr>
					<tr>
					    <td bgcolor="#efefef">Time</td>
				    ...
				    <tr>
					    <td bgcolor="#efefef">Description</td>
						<td><?php echo $calendar->calendar_desc ?></td>
				    </tr>
					<tr>
					    <td bgcolor="#efefef">Created by</td>
					...
					<tr>
						...
						<td>
							<table width="100%">
								<tr>								    
									<td align="right"><a onclick="close_modal()" class="btn btn-warning btn-round" style="margin: 0px">Close</a></td>
								</tr>
							</table>
						</td>
				    </tr>
