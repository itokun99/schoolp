	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-content">
				<h4 class="card-title"><?php echo $student->fullname ?> Detail Sekolah</h4>
				<div class="row">
						...
						<div class="box-body">
							<div class="row">	
								 ...
								 <div class="col-lg-12">
									<table width="100%">
										<tr>
											<td><a href="school" class="btn btn-default">Kembali</a></td>
											<td align="right">
												<a href="#" data-toggle="modal" data-load-url="assessment/add_assessment/<?php echo $student->memberid ?>/<?php echo $classroom->classroomid ?>/<?php echo $school->schoolid ?>" class="btn btn-info" data-target="#myModalTeacherAssessment" title="Teacher Assessment">Penilaian Guru</a>
												&nbsp;&nbsp;&nbsp;&nbsp;
												<a href="#" data-toggle="modal" data-load-url="suggestion/add_suggestion/<?php echo $student->memberid ?>/<?php echo $school->schoolid ?>" class="btn btn-info" data-target="#myModalSuggestion" title="Add Suggestion">Tambah Saran</a>
											</td>
										</tr>
									</table>
								 ...
								 <div class="col-lg-6">
									 <table class="table table-bordered">
										 <tbody>
										 <tr>
											 <td bgcolor="#f7f7f7" width="140"><b>Sekolah</b></td>
										...
										<div id="tabs">
											<ul class="nav nav-pills nav-pills-warning" id="prodTabs">
												<li class="<?php echo $class_active_1 ?>">
													<a href="#class_menu_schedule" id="class_menu_sch" data-url="<?php url("classroom/class_schedule/$student->memberid/$classroom->classroomid/$school->schoolid"); ?>">Jadwal</a>
												</li>
												<li class="<?php echo $class_active_7 ?>">
													<a href="#class_menu_dailyexam" id="class_menu_dexam" data-url="<?php url("classroom/class_daily_exam/$student->memberid/$classroom->classroomid/$school->schoolid"); ?>">Tugas Kelas</a>
												</li>
												<li class="<?php echo $class_active_8 ?>">
													<a href="#class_menu_exam" id="class_menu_sexam" data-url="<?php url("classroom/class_exam_schedule/$student->memberid/$classroom->classroomid/$school->schoolid"); ?>">Ujian</a>
												</li>
												...
												<li class="<?php echo $class_active_2 ?>">
													<a href="#class_menu_message" id="class_menu_msg" data-url="<?php url("message/student_inbox/$student->memberid/$school->schoolid"); ?>">Pesan</a>
												</li>
												<li class="<?php echo $class_active_3 ?>">
													<a href="#class_menu_calendar" id="class_menu_cal" data-url="<?php url("classroom/class_calendar/$classroom->classroomid/$school->schoolid"); ?>">Kalender</a>
												</li>												
												<li class="<?php echo $class_active_4 ?>">
													<a href="#class_menu_attendance">Absensi</a>
												</li>
												<!-- <li class="<?php echo $class_active_4 ?>">
													<a href="#class_menu_fee">School Fees</a>
												</li> -->
												<li class="<?php echo $class_active_5 ?>">
													<a href="#class_menu_announcement" id="class_menu_ann" data-url="<?php url("announcement/index/$student->memberid/$school->schoolid"); ?>">Pengumuman</a>
												</li>
											</ul>
								 ...
								 <?php } else { ?>
									<div style="height:100px"></div>
								   	<div align='center' class='alert-box info'>Siswa tidak dapat hadir dikelas. <br> Silahkan hubungi sekolah.</div>								   
								 <?php } ?>
	...
	<div class="modal-dialog modal-big">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h5 class="modal-title" id="myModalLabel"><strong>Tambah Saran Baru</strong></h5>
			</div>
...
<div class="modal fade" id="myModalTeacherAssessment" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
	<div class="modal-dialog modal-big">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="material-icons">clear</i></button>
				<h5 class="modal-title" id="myModalLabel"><strong>Penilaian Guru</strong></h5>
			</div>
			<div class="modal-body">
				<div class="instruction">
					<div class="row">
