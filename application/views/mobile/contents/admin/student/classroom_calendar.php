						...
						<div class="col-md-12" style="min-height: 400px">
							...
							<div class="box-body">
								...
								<?php } else { ?>
									...
									<div align='center' class='alert-box info'>Tidak Ada Peristiwa di Database.</div>
								<?php } ?>
							</div>
	...
	$(document).ready(function() {
        ...
        $('#calendarIO').fullCalendar({
			...
			eventClick: function(event, element)
			{
				...
				$("#CalendarMd").attr('src', "classroom/view_calendar/" + event.id + "/<?php echo $classroom_id ?>" + "/<?php echo $school_id ?>");
				setTimeout(function() {
