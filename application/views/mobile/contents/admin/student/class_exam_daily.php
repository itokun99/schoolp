											...
											<table id="reportTables" class="table" cellspacing="0" width="100%">										  
											  ...
											  <tbody>
												...
												<td bgcolor="#dddddd" style="width: 100px;">Tanggal</td>
												  <td style="" data-order="<?php echo $data->exam_date ?>"><?php echo $data->exam_date_ok ?></td>
												</tr>

												<tr>
												<td bgcolor="#dddddd" style="width: 100px;">Mata Pelajaran</td>
												  <td style=""><?php echo $data->cources_name ?>
												        <?php
												  ...
												  <tr>
												  <td bgcolor="#dddddd" style="width: 100px;">Tipe</td>
												  <td style=""><?php echo $data->exam_type_name ?></td>
												  </tr>

												  <tr>
												  <td bgcolor="#dddddd" style="width: 100px;">Deskripsi</td>
												  <td style=""><?php echo $data->exam_desc ?></td>
												  </tr>

												  <tr>
												  <td bgcolor="#dddddd" style="width: 100px;">Guru</td>
												  <td style=""><?php echo $data->teacher_name ?></td>
												  </tr>

												  <tr>
												  <td bgcolor="#dddddd" style="width: 100px;">Nilai</td>
												  <td style=""><?php echo $data->score_value ?></td>
												</tr>
												</table></td></tr>
												<?php } ?>
											  </tbody>
