												...
												<table id="datatable">
													<tbody>
														<tr>
															...
															<td>																		
																<select name="year_ok" class="form-control" style="width: 90px; display: inline;" autocomplete="off" required="yes">															
									...
									<tr>
										<td>
											<table class="table table-bordered" cellspacing="0" width="100%">
												<tr>
													<td bgcolor="#C3FCBE" style="width: 120px;">Month</td>
													<td style="text-align: left" data-order="<?php echo $data_month[$j]->month_id ?>"><?php echo $data_month[$j]->month_name ?></td>
												</tr>
												<tr>
													<td bgcolor="#C3FCBE">Student Fee</td>
													<td style="text-align: left"><?php echo number_format($data_month[$j]->student_fee) ?></td>
												</tr>
												<tr>
													<td bgcolor="#C3FCBE">Payment Status</td>
